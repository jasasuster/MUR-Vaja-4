...
import { COLORS, ROLES, FILE_NAMES } from './types';
import { SquareSet } from './squareSet';
import { Board } from './board';
import { Material, RemainingChecks } from './setup';
...
export function parseBoardFen(boardPart) {
...
export function parsePockets(pocketPart) {
...
export function parseCastlingFen(board, castlingPart) {
...
export function parseRemainingChecks(part) {
...
export function parseFen(fen) {
    ...
    // Board and pockets
    let board, pockets = Result.ok(undefined);
...
export function makePiece(piece, opts) {
...
export function makeBoardFen(board, opts) {
    let fen = '';
    let empty = 0;
...
export function makeRemainingChecks(checks) {
    return `${checks.white}+${checks.black}`;
}
export function makeFen(setup, opts) {
    return [
